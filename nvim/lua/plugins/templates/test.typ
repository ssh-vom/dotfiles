...
#show: minimal-note.with(
  title: [], author: [Your Name], date: datetime.today().display("[month repr:long], [year]"),
)

= Basic Probability Laws

These probability laws, such as the #link(<chain-rule>, "Chain Rule") are
fundamental. You can learn more about the link Chain Rule in #link("https://www.youtube.com/watch?v=wl1myxrtQHQ", "this video").
...
#algorithm-figure("Posterior Sampling for Reinforcement Learning (PSRL)", inset: 3.5pt, {
  import algorithmic: *
